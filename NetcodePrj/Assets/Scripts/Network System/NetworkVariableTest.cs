...
{
    // Unity doc
    // Network Variables kullanılmasındaki temel motivasyon tüm oyuncularda senkron değişkenler yaratmaktır.
   ...
   public override void OnNetworkSpawn()
   {
       if (IsServer)
       {
           ...
           NetworkManager.OnClientConnectedCallback += NetworkManager_OnClientConnectedCallback;        // herhangi bir client oyuna bağlanırsa bu event çalışacak
       }
       else
       {
